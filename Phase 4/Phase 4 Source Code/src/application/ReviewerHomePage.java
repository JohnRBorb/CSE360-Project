...
public class ReviewerHomePage {
    ...
    public void show(Stage primaryStage) {
        ...
        Button profileEditButton = new Button("Edit My Profile");
        profileEditButton.setOnAction(e -> 
        new ReviewerProfileEditorPage(databaseHelper, user.getUserName(), user).show(primaryStage));
    
        Button profileViewButton = new Button("View My Profile");
        profileViewButton.setOnAction(e -> 
        new ReviewerPersonalProfilePage(databaseHelper, user.getUserName(), user).show(primaryStage));
        ...
        layout.getChildren().addAll(userLabel, qaButton, profileEditButton, profileViewButton,
        		inboxButton, logoutButton, quitButton);
